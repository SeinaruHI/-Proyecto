...
class LIstActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val result = App.dm.api
            .getProducts()
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .subscribe({ result ->
                Toast.makeText(this, result.data.total, Toast.LENGTH_SHORT).show()
        ...
        val dataList = listOf(
            ExampleData(name = "Даниил", surname = "Даниилов", age = 32),
            ExampleData(name = "Александр", surname = "Александрович", age = 20)
        )
